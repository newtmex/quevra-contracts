...
/// @notice Official Monad staking precompile at `0x1000`.
/// @dev Copied from https://docs.monad.xyz/developer-essentials/staking/staking-precompile
///      Only CALL is allowed; view methods are therefore nonpayable rather than `view`.
